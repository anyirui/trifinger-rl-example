...
class ExpertPolicy(PolicyBase):
    ...
    def __init__(
        ...
        # # load torch script
        # torch_model_path = (
        #     "/is/sg2/iandrussow/trifinger_robot/trained_models/expert/policy.pt"
        # )
        ...
        self.ort_session = ort.InferenceSession(
            "/is/sg2/iandrussow/trifinger_robot/trained_models/expert/policy.onnx"
        )
...
class SmoothExpertPolicy(PolicyBase):
    ...
    def get_action(self, observation):
        ...
        if self.last_action is None:
            ...
            action = (1.0 - self.action_low_pass) * self.last_action + (
                self.action_low_pass
            ) * action_target
